...
//	//lower bound
//	if (string_char_at(passwords[_i], _string_pos + 1) != "-"){
//		var _lower_bound = string_copy(passwords[_i], _string_pos, 2)
//		_string_pos += 3
//	}
//	else{
//		var _lower_bound = string_char_at(passwords[_i], _string_pos)
//		_string_pos += 2
//	}
	
//	//upper bound
//	if (string_char_at(passwords[_i], _string_pos + 1) != " "){
//		var _upper_bound = string_copy(passwords[_i], _string_pos, 2)
//		_string_pos += 3
//	}
//	else{
//		var _upper_bound = string_char_at(passwords[_i], _string_pos)
//		_string_pos += 2
//	}
	
//	//letter
//	var _letter = string_char_at(passwords[_i], _string_pos)
//	_string_pos += 3
	
//	//password
//	var _password = string_copy(passwords[_i], _string_pos, string_length(passwords[_i]) - _string_pos + 1)
	
//	//check!
//	var _letter_count = string_count(_letter, _password)
	
//	if (_letter_count >= _lower_bound && _letter_count <= _upper_bound){
//		count++
//	}
	
//	show_debug_message("Lower bound: " + string(_lower_bound) + "\n" + "Upper bound: " + string(_upper_bound) + "\n" + "Letter: " + string(_letter) + "\n" + "Password: " + string(_password) + "\n" + "Letter Count: " + string(_letter_count) + "\n" + "Password Count: " + string(count))
//}
