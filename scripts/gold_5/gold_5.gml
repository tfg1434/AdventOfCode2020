...
//for (var _i = 0; _i < array_length(seats) - 1; _i++){
//	ds_list_add(id_list, get_seat_id(seats[_i]))
//}
//ds_list_sort(id_list, true)

//for (var _i = 1; _i < ds_list_size(id_list) - 1; _i++){
//	if (id_list[| _i - 1] == id_list[| _i] - 2){
//		_my_seat_id = id_list[| _i] - 1
//		break
//	}
//}

//show_message("Missing seat id (mine): " + string(_my_seat_id))
